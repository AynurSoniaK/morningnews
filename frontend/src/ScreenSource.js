...
//import { REACT_APP_CLE_API} from '@env';
...
function ScreenSource(props) {
  ...
  useEffect(() => {
    const APIResultsLoading = async() => {
      ...
      const data = await fetch(`https://newsapi.org/v2/sources?language=${langue}&country=${country}&apiKey=${process.env.REACT_APP_CLE_API}`)
